...
// Curator's BaseClassForTests) and Oozie.  This is to ensure that the ChildReaper
// class we modified is still correct.
public class TestChildReaper extends ZKXTestCase
{
  ...
  public void     testSomeNodes() throws Exception
  {
    ...
    CuratorFramework        client = CuratorFrameworkFactory.newClient(getConnectString(), timing.session(), timing.connection(), new RetryOneTime(1));
    try
    {
      client.start();
