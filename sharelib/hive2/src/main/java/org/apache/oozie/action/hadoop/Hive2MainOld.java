...
/**
 * Similar to the regular HiveMain (for using with the Hive schema and HiveActionExecutor) but uses BeeLine instead of HiveCLI
 *
 * DEPRECATED: The Hive 2 action should be used instead
 */
@Deprecated
public class Hive2MainOld extends LauncherMain {
    ...
    protected void run(String[] args) throws Exception {
        System.out.println();
        System.out.println("WARNING: Using the Hive action with Hive Server 2 is DEPRECATED.");
        System.out.println("         Users are encouraged to switch to the Hive 2 action instead.");
        System.out.println();
        System.out.println();
